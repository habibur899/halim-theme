...
// This is an example of how to include a plugin bundled with a theme.
		array(
			'name'     => 'Halim Core', // The plugin name.
			'slug'     => 'halim-core', // The plugin slug (typically the folder name).
			'source'   => get_template_directory() . '/plugins/halim-core.zip', // The plugin source.
